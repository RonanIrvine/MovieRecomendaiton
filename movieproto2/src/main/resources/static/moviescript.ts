...
// //getting movie genre id
// const genretag = (document.getElementById("genre_id") as HTMLElement)
// //setting variable for navigation
...
//       const highlightedTag = document.getElementById(id.toString());
//       if (highlightedTag) {
...
//     });
// }
// function showMovies(movies: Array<any>): void {
//   main.innerHTML = '';
//
...
//     movieEl.innerHTML = `
//         <img radius="60px" src="${IMG_PATH + poster_path}" alt="${title}">
...
//       ${overview}
//       <br></br>
//       <button class="trailerbutt" id="${id}">Trailer</button>
//       </div>
//     `;
//
...
// const rightArrow = document.getElementById('right-arrow') as HTMLButtonElement;
//
